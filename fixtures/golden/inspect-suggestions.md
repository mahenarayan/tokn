...
- Provider: openai
- Model: gpt-4o
- Input tokens: 112000 (exact)
- Headroom: 11904 remaining
- Risk: high (87.5%)

## Segments
| Label | Tokens | Type | Confidence | Reclaimability |
| --- | --- | --- | --- | --- |
| Provider overhead | 110925 | provider_overhead | provider-reported | keep |
| Declared tools | 375 | tool_schema | provider-reported | cache |
| assistant message 2 | 300 | assistant_history | provider-reported | summarize |
| user message 3 part 2 | 182 | retrieval_context | provider-reported | cache |
| user message 3 part 3 | 182 | retrieval_context | provider-reported | cache |
| system message 1 | 20 | system | provider-reported | keep |
| user message 3 part 1 | 16 | user | provider-reported | drop |
