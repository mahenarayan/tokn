...
Use this when maintainers, platform teams, developer-experience teams, or AI enablement teams want one reviewable `tokn.config.json` pattern that can move from visibility to enforcement across one or many repositories.
